use crate::{
    poseidon2::{
        ...
        chip::{
            decomposition::{
                F_MS_LIMB, F_MS_LIMB_BITS, F_MS_LIMB_LEADING_ONES, F_MS_LIMB_TRAILING_ZEROS,
                LIMB_BITS, LIMB_MASK, NUM_LIMBS, NUM_MSG_HASH_LIMBS,
                column::{DecompositionCols, NUM_DECOMPOSITION_COLS},
            },
            range_check::RangeCheckInteraction,
        },
        hash_sig::{CHUNK_SIZE, MSG_HASH_FE_LEN, VerificationTrace},
    },
    util::{
