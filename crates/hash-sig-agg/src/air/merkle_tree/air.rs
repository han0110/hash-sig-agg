use crate::{
    ...
    gadget::{not, select},
    hash_sig::{
        F, HALF_FULL_ROUNDS, HASH_FE_LEN, MSG_FE_LEN, PARAM_FE_LEN, Poseidon2LinearLayers, RC24,
        SBOX_DEGREE, SBOX_REGISTERS, SPONGE_CAPACITY_VALUES, SPONGE_RATE, TWEAK_FE_LEN,
    },
    util::zip,
};
    ...
    AB: AirBuilder<F = F>,
{
    ...
    builder.assert_bools(cols.is_receive_merkle_tree);
    ...
    AB: AirBuilder<F = F>,
{
    ...
    builder.assert_zeros(local.merkle_leaf_padding());
    ...
    AB: AirBuilder<F = F>,
{
    ...
    builder.assert_zeros(cols.merkle_path_padding());
}
    ...
    AB: AirBuilder<F = F>,
{
    ...
    builder.assert_zeros(local.msg_hash_padding());
    ...
    AB: AirBuilder<F = F>,
{
    ...
    builder.assert_zero(local.sig_idx);
    builder.assert_zeros(local.is_receive_merkle_tree);
